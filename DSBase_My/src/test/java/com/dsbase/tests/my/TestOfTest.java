...
//		// реестр сообщений ПР
        ...
        addMasterFile_My.AnneхD_FillUp();
        addMasterFile_My.AnneхE_FillUp();
        addMasterFile_My.AnneхF_FillUp();
        addMasterFile_My.AnneхG_FillUp();
        addMasterFile_My.AnneхH_FillUp();
        addMasterFile_My.AnneхI_FillUp();
        masterFileRegistry_My.load();
//        drugRegistryPage_My.loadAndWaitUntilAvailable();
//        drugRegistryPage_My.drug_Search();
//        drugRegistryPage_My.drug_Delete();      
//        drugRegistryPage_My.deletedDrug_check();
//        staffRegistry.loadAndWaitUntilAvailable();
//        staffRegistry.SearchStaff();
//        staffRegistry.Staff_Delete();
