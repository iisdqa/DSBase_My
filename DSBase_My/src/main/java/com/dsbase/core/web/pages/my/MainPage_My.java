...
public class MainPage_My extends WebPage<MainPage_My>{
	...
	public boolean isAvailable(){
			return getLicense_Link().isAvailable(); // Элемент, который ожидается при загрузке страницы(т.е. можно менять)
	}
...
/*			// hover
	...
	private Custom getLicense_Link(){
		return new Custom(driver, By.xpath("//span[text() = 'Лицензия']"));
	}
